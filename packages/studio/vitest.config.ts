...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@cn-godhei/inkos-core/interactive-film/evaluator": resolve(__dirname, "../core/src/interactive-film/evaluator.ts"),
      "@cn-godhei/inkos-core/interactive-film/graph-schema": resolve(__dirname, "../core/src/interactive-film/graph-schema.ts"),
      "@cn-godhei/inkos-core/forecast/schema": resolve(__dirname, "../core/src/forecast/schema.ts"),
      "@cn-godhei/inkos-core": resolve(__dirname, "../core/src/index.ts"),
    },
  },
  test: {
    include: ["src/**/*.test.ts"],
